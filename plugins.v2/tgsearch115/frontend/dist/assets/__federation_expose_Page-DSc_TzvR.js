...
const {resolveComponent:_resolveComponent,createVNode:_createVNode,createTextVNode:_createTextVNode,withCtx:_withCtx,toDisplayString:_toDisplayString,createElementVNode:_createElementVNode,withModifiers:_withModifiers,withKeys:_withKeys,normalizeClass:_normalizeClass,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode,renderList:_renderList,Fragment:_Fragment,createBlock:_createBlock,vShow:_vShow,withDirectives:_withDirectives,unref:_unref} = await importShared('vue');
      ...
      default: _withCtx(() => [
        _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
          default: _withCtx(() => [
            ...
            _cache[11] || (_cache[11] = _createTextVNode("手动搜索 ", -1))
          ]),
          _: 1
        }),
      ...
      default: _withCtx(() => [
        _createVNode(_component_v_card_title, {
          ...
          default: _withCtx(() => [
            ...
            _cache[27] || (_cache[27] = _createTextVNode("订阅处理诊断 ", -1)),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, {
              ...
              default: _withCtx(() => [
                ...
                _cache[31] || (_cache[31] = _createTextVNode(" 磁力下载任务 ", -1)),
                _createVNode(_component_v_chip, {
                  size: "x-small",
                  variant: "tonal",
                  class: "ml-2"
                ...
                _createVNode(_component_v_btn, {
                  ...
                  default: _withCtx(() => [
                    _cache[29] || (_cache[29] = _createTextVNode("清除记录 ", -1)),
                    _createVNode(_component_v_tooltip, {
                      activator: "parent",
                      location: "top"
                    }, {
            ...
            _createVNode(_component_v_expand_transition, null, {
              default: _withCtx(() => [
                _withDirectives(_createElementVNode("div", null, [
                  _createVNode(_component_v_divider),
                  _cache[35] || (_cache[35] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "115 直接磁力状态来自插件脱敏台账；手动取消只对可识别的当前任务可用", -1)),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center" }, {
              default: _withCtx(() => [
                ...
                _cache[36] || (_cache[36] = _createTextVNode("确认清除任务记录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_card_text, null, {
              default: _withCtx(() => [
                ...
                (activeTaskCount.value)
                  ...
                  : _createCommentVNode("", true),
                _cache[37] || (_cache[37] = _createElementVNode("p", { class: "text-medium-emphasis" }, "不会删除 115 文件，不会取消离线下载，也不会修改订阅。", -1))
              ]),
              _: 1
            }),
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a95120b2"]]);
