...
const _hoisted_8 = { class: "px-3 pt-2 pb-1" };
const _hoisted_9 = { class: "d-flex align-start" };
const _hoisted_10 = { class: "channel-meta flex-grow-1" };
const _hoisted_11 = { class: "d-flex align-center flex-wrap ga-1" };
...
const _hoisted_16 = { class: "d-flex flex-column align-end ml-2 mt-1" };
const _hoisted_17 = {
  key: 2,
...
const _hoisted_19 = { class: "d-flex align-center mb-2 flex-wrap ga-2" };
const _hoisted_20 = {
  key: 0,
  class: "channel-list"
};
const _hoisted_21 = { class: "d-flex align-center px-3 py-2" };
const _hoisted_22 = { class: "channel-meta" };
const _hoisted_23 = { class: "text-body-2 font-weight-medium text-truncate" };
const _hoisted_24 = { class: "text-caption text-medium-emphasis text-truncate" };
const _hoisted_25 = {
  key: 1,
  class: "empty-state"
};
...
const _hoisted_28 = { class: "d-flex align-center justify-center" };
const _hoisted_29 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_30 = { class: "d-flex align-center px-2 py-1 flex-wrap" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
        ...
        _createVNode(_component_v_window, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[48] || (_cache[48] = _createElementVNode("div", { class: "section-label mb-2" }, "手动转存 115 资源", -1)),
                _createVNode(_component_v_text_field, {
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[60] || (_cache[60] = _createElementVNode("div", { class: "section-label mb-2" }, "手动搜索（TG 频道 + 观影）", -1)),
                _createElementVNode("div", _hoisted_4, [
                  _cache[52] || (_cache[52] = _createElementVNode("span", { class: "text-caption text-medium-emphasis" }, "来源", -1)),
                ...
                (searchLoading.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_6, [
                      ...
                      _cache[54] || (_cache[54] = _createElementVNode("div", { class: "text-body-2" }, "正在搜索...", -1))
                    ]))
                  : (searchResults.value.length)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_7, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(searchResults.value.slice(0, displayLimit.value), (r, i) => {
                                ...
                                _createElementVNode("div", _hoisted_9, [
                                  ...
                                  _createElementVNode("div", _hoisted_10, [
                                    _createElementVNode("div", _hoisted_11, [
                                      _createElementVNode("span", _hoisted_12, _toDisplayString(r.title), 1),
                                      _createVNode(_component_v_chip, {
                                        size: "x-small",
                                    ...
                                    _createElementVNode("div", _hoisted_14, [
                                      ...
                                      (r.pub_date)
                                        ? (_openBlock(), _createElementBlock("span", _hoisted_15, " · " + _toDisplayString(r.pub_date), 1))
                                        : _createCommentVNode("", true)
                                    ])
                                  ]),
                    ...
                    : _createCommentVNode("", true),
                (searchResults.value.length > displayLimit.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_17, [
                      _createVNode(_component_v_btn, {
                        ...
                        default: _withCtx(() => [
                          _cache[57] || (_cache[57] = _createTextVNode(" 加载更多 ", -1)),
                          _createVNode(_component_v_icon, {
                  ...
                  : (searched.value && !searchLoading.value)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_18, [
                        ...
                        _cache[58] || (_cache[58] = _createElementVNode("div", { class: "text-body-2" }, "未找到资源", -1)),
                        _cache[59] || (_cache[59] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mt-1" }, "提示：TG 用片名搜全历史；观影需在「插件设置」配置 app_auth", -1))
                      ]))
                    : _createCommentVNode("", true)
              ]),
              _: 1
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[68] || (_cache[68] = _createElementVNode("div", { class: "section-label mb-2" }, "添加频道", -1)),
                _createVNode(_component_v_card, {
                  variant: "tonal",
                  color: "primary",
                  rounded: "lg",
                            ...
                            _createVNode(_component_v_col, {
                              ...
                              default: _withCtx(() => [
                                _createVNode(_component_v_text_field, {
                                  ...
                                  "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((newName).value = $event)),
                                  label: "频道名称",
                                  variant: "outlined",
                                  density: "comfortable",
                                  "hide-details": ""
                            ...
                            _createVNode(_component_v_col, {
                              ...
                              default: _withCtx(() => [
                                _createVNode(_component_v_text_field, {
                                  ...
                                  "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((newId).value = $event)),
                                  label: "频道 ID / 链接",
                                  variant: "outlined",
                                  density: "comfortable",
                                  hint: "@用户名 / 邀请链接 / 数字 ID",
                ...
                _createElementVNode("div", _hoisted_19, [
                  _cache[65] || (_cache[65] = _createElementVNode("span", { class: "section-label" }, "已添加频道", -1)),
                  _createVNode(_component_v_chip, {
                    size: "small",
                    variant: "tonal"
                  }, {
                ...
                (channels.value.length)
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_21, [
                              ...
                              _createElementVNode("div", _hoisted_22, [
                                _createElementVNode("div", _hoisted_23, _toDisplayString(ch.name), 1),
                                _createElementVNode("div", _hoisted_24, _toDisplayString(ch.id), 1)
                              ]),
                              (!channelSelectMode.value)
                                ? (_openBlock(), _createBlock(_component_v_btn, {
                                    key: 1,
                  ...
                  : (_openBlock(), _createElementBlock("div", _hoisted_25, [
                      ...
                      _cache[67] || (_cache[67] = _createElementVNode("div", { class: "text-body-2" }, "暂未添加任何 TG 频道", -1))
                    ]))
              ]),
              _: 1
            }),
                ...
                _createVNode(_component_v_row, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[69] || (_cache[69] = _createElementVNode("div", { class: "mr-2" }, [
                        ...
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((config.auto_finish) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[70] || (_cache[70] = _createElementVNode("div", { class: "mr-2" }, [
                        ...
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((config.use_rule_groups) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[71] || (_cache[71] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "转存成功通知", -1)),
                        _createVNode(_component_v_switch, {
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[72] || (_cache[72] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "未命中通知", -1)),
                        _createVNode(_component_v_switch, {
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[75] || (_cache[75] = _createElementVNode("div", { class: "section-label mb-2" }, "观影站点", -1)),
                _cache[76] || (_cache[76] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, "PoW 验证 + 全网盘资源 + 磁力链接搜索；仅 115 自动转存，其它网盘/磁力仅展示链接。换域名在下方「观影站点域名」填写", -1)),
                _createVNode(_component_v_row, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_v_col, {
                      cols: "12",
                      ...
                      default: _withCtx(() => [
                        _cache[73] || (_cache[73] = _createElementVNode("div", { class: "mr-2" }, [
                        ...
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((config.site_enabled) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, { cols: "12" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((config.site_domain) = $event)),
                          label: "观影站点域名",
                    ...
                    _createVNode(_component_v_col, { cols: "12" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((config.site_app_auth) = $event)),
    ...
    _createVNode(_component_v_dialog, {
      ...
      "onUpdate:modelValue": _cache[25] || (_cache[25] = $event => ((importDialog).value = $event)),
      "max-width": "640"
    }, {
      default: _withCtx(() => [
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[77] || (_cache[77] = _createTextVNode("批量导入频道 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, { class: "px-4 py-4" }, {
              default: _withCtx(() => [
                _createVNode(_component_v_textarea, {
                  ...
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((importJson).value = $event)),
            ...
            _createVNode(_component_v_card_actions, { class: "px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_v_btn, {
                  variant: "text",
                  onClick: _cache[24] || (_cache[24] = $event => (importDialog.value = false))
                }, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[80] || (_cache[80] = _createTextVNode("确认删除 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
    ...
    _createVNode(_component_v_dialog, {
      ...
      "onUpdate:modelValue": [
        _cache[29] || (_cache[29] = $event => ((qrDialog).value = $event)),
        onQrDialogToggle
      ],
      "max-width": "420"
    }, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[85] || (_cache[85] = _createTextVNode("115 扫码登录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, { class: "px-4 py-4 text-center" }, {
              default: _withCtx(() => [
                _createVNode(_component_v_select, {
                  ...
                  "onUpdate:modelValue": [
                    _cache[28] || (_cache[28] = $event => ((qrApp).value = $event)),
                    refreshQrcode
                  ],
                  items: qrApps,
                  "item-title": "title",
                ...
                _createElementVNode("div", _hoisted_28, [
                  (qrPolling.value)
                    ...
                    : _createCommentVNode("", true),
                  _createElementVNode("span", _hoisted_29, _toDisplayString(qrMsg.value || '请使用 115 客户端扫码'), 1)
                ])
              ]),
              _: 1
            }),
    ...
    _createVNode(_component_v_dialog, {
      ...
      "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((dirBrowserOpen).value = $event)),
      "max-width": "560"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_v_card, { rounded: "lg" }, {
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[88] || (_cache[88] = _createTextVNode("选择 115 目录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, {
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_30, [
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(dirBrowserPath.value.slice(1), (p, i) => {
                    return (_openBlock(), _createElementBlock(_Fragment, { key: i }, [
                      ...
                      _createElementVNode("span", _hoisted_31, _toDisplayString(p.name), 1)
                    ], 64))
                  }), 128)),
                  _createVNode(_component_v_spacer),
                ...
                (!dirBrowserLoading.value && !dirBrowserDirs.value.length)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_32, "无子目录"))
                  : _createCommentVNode("", true)
              ]),
              _: 1
            }),
            ...
            _createVNode(_component_v_card_actions, { class: "px-4 py-3" }, {
              default: _withCtx(() => [
                _createElementVNode("span", _hoisted_33, "当前: " + _toDisplayString(dirBrowserPathStr.value || '/'), 1),
                _createVNode(_component_v_spacer),
                _createVNode(_component_v_btn, {
                  variant: "text",
                  onClick: _cache[30] || (_cache[30] = $event => (dirBrowserOpen.value = false))
                }, {
    ...
    _createVNode(_component_v_dialog, {
      ...
      "onUpdate:modelValue": _cache[33] || (_cache[33] = $event => ((batchDeleteDialog).value = $event)),
      "max-width": "420"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_v_card, { rounded: "lg" }, {
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[95] || (_cache[95] = _createTextVNode("确认批量删除 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, { class: "text-body-2 pt-4" }, {
              default: _withCtx(() => [
                _cache[96] || (_cache[96] = _createTextVNode(" 确定要删除选中的 ", -1)),
                _createElementVNode("strong", null, _toDisplayString(selectedChannels.value.length), 1),
                _cache[97] || (_cache[97] = _createTextVNode(" 个频道吗？此操作不可撤销。 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_actions, { class: "px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_v_btn, {
                  variant: "text",
                  onClick: _cache[32] || (_cache[32] = $event => (batchDeleteDialog.value = false))
                }, {
    ...
    _createVNode(_component_v_snackbar, {
      ...
      "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((snackModel).value = $event)),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-83fee8eb"]]);
