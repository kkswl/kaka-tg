...
const _hoisted_22 = { class: "d-flex align-center mb-2 flex-wrap ga-2" };
const _hoisted_23 = {
  key: 0,
  class: "channel-list"
};
const _hoisted_24 = { class: "d-flex align-center px-3 py-2" };
const _hoisted_25 = { class: "channel-meta" };
const _hoisted_26 = { class: "text-body-2 font-weight-medium text-truncate" };
const _hoisted_27 = { class: "text-caption text-medium-emphasis text-truncate" };
const _hoisted_28 = {
  key: 1,
  class: "empty-state"
};
...
const _hoisted_31 = { class: "d-flex align-center justify-center" };
const _hoisted_32 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_33 = { class: "d-flex align-center px-2 py-1 flex-wrap" };
        ...
        _createVNode(_component_v_window, {
          ...
          default: _withCtx(() => [
                            ...
                            _createVNode(_component_v_col, {
                              ...
                              default: _withCtx(() => [
                                _createVNode(_component_v_text_field, {
                                  ...
                                  "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((newName).value = $event)),
                                  label: "频道名称",
                                  variant: "outlined",
                                  density: "comfortable",
                                  "hide-details": ""
                            ...
                            _createVNode(_component_v_col, {
                              ...
                              default: _withCtx(() => [
                                _createVNode(_component_v_text_field, {
                                  ...
                                  "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((newId).value = $event)),
                                  label: "频道 ID / 链接",
                                  variant: "outlined",
                                  density: "comfortable",
                                  hint: "@用户名 / 邀请链接 / 数字 ID",
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_24, [
                              ...
                              _createElementVNode("div", _hoisted_25, [
                                _createElementVNode("div", _hoisted_26, _toDisplayString(ch.name), 1),
                                _createElementVNode("div", _hoisted_27, _toDisplayString(ch.id), 1)
                              ]),
                              (!channelSelectMode.value)
                                ? (_openBlock(), _createBlock(_component_v_btn, {
                                    key: 1,
                ...
                _createVNode(_component_v_row, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        ...
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((config.auto_finish) = $event)),
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        ...
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((config.use_rule_groups) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[121] || (_cache[121] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "周期搜索 MP 活动订阅", -1)),
                        _createVNode(_component_v_spacer),
                        _createVNode(_component_v_switch, {
                          modelValue: config.periodic_enabled,
                          "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((config.periodic_enabled) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_select, {
                          ...
                          "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((config.period_hours) = $event)),
                          items: periodOptions,
                          label: "搜索周期",
                          variant: "outlined",
                          density: "compact",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((config.jitter_minutes) = $event)),
                          label: "随机抖动（分钟）",
                          type: "number",
                          min: "0",
                          max: "10",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((config.search_cache_hours) = $event)),
                          label: "搜索缓存（小时）",
                          type: "number",
                          min: "1",
                          max: "6",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_select, {
                          ...
                          "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((config.tg_concurrency) = $event)),
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((config.tg_page_delay_min) = $event)),
                          label: "TG 最小间隔（秒）",
                          type: "number",
                          step: "0.1",
                          min: "0.2",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((config.tg_page_delay_max) = $event)),
                          label: "TG 最大间隔（秒）",
                          type: "number",
                          step: "0.1",
                          min: "0.2",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[24] || (_cache[24] = $event => ((config.source_item_delay_min) = $event)),
                          label: "订阅最小间隔（秒）",
                          type: "number",
                          min: "0",
                          variant: "outlined",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[25] || (_cache[25] = $event => ((config.source_item_delay_max) = $event)),
                          label: "订阅最大间隔（秒）",
                          type: "number",
                          min: "0",
                          variant: "outlined",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[26] || (_cache[26] = $event => ((config.source_failure_threshold) = $event)),
                          label: "熔断失败次数",
                          type: "number",
                          min: "1",
                          max: "5",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_select, {
                          ...
                          "onUpdate:modelValue": _cache[27] || (_cache[27] = $event => ((config.source_cooldown_minutes) = $event)),
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[122] || (_cache[122] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "转存成功通知", -1)),
                        _createVNode(_component_v_switch, {
                          modelValue: config.notify_success,
                          "onUpdate:modelValue": _cache[28] || (_cache[28] = $event => ((config.notify_success) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[123] || (_cache[123] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "未命中通知", -1)),
                        _createVNode(_component_v_switch, {
                          modelValue: config.notify_fail,
                          "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((config.notify_fail) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[132] || (_cache[132] = _createElementVNode("div", { class: "section-label mb-2" }, "观影站点", -1)),
                _cache[133] || (_cache[133] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, "PoW 验证 + 全网盘资源 + 磁力链接搜索；中字 1080P/4K 磁力经 MoviePilot 确认后优先通过插件内置 115 离线，失败才回退 CMS。", -1)),
                _createVNode(_component_v_row, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_v_col, {
                      cols: "12",
                      ...
                      default: _withCtx(() => [
                        _cache[124] || (_cache[124] = _createElementVNode("div", { class: "mr-2" }, [
                        ...
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[30] || (_cache[30] = $event => ((config.site_enabled) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[126] || (_cache[126] = _createElementVNode("div", { class: "mr-3" }, [
                          _createElementVNode("div", { class: "text-subtitle-2" }, "完整磁力优先离线到 115"),
                          _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "先用 MP 规则与媒体 ID 确认；只自动处理中字 1080P/4K 磁力，插件内置 115 失败时才回退 CMS")
                        ], -1)),
                        _createVNode(_component_v_spacer),
                        _createVNode(_component_v_switch, {
                          modelValue: config.site_magnet_priority,
                          "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((config.site_magnet_priority) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          modelValue: config.cms_url,
                          "onUpdate:modelValue": _cache[32] || (_cache[32] = $event => ((config.cms_url) = $event)),
                          label: "CMS 服务地址",
                          placeholder: "http://192.168.1.15:9527",
                          variant: "outlined",
                          density: "compact",
                          "hide-details": ""
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_btn, {
                          ...
                          variant: "outlined",
                          "prepend-icon": "mdi-connection",
                          loading: cmsChecking.value,
                          onClick: checkCms
                        }, {
                          default: _withCtx(() => [...(_cache[127] || (_cache[127] = [
                            _createTextVNode("检查 CMS", -1)
                          ]))]),
                          _: 1
                        }, 8, ["loading"]),
                        _createVNode(_component_v_btn, {
                    ...
                    _createVNode(_component_v_col, { cols: "12" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          modelValue: config.cms_token,
                          "onUpdate:modelValue": _cache[33] || (_cache[33] = $event => ((config.cms_token) = $event)),
                          label: "CMS API Token",
                          type: showSecrets.value ? 'text' : 'password',
                          variant: "outlined",
                          density: "compact",
                          "hide-details": "",
                          hint: "对应 CMS_API_TOKEN；仅保存在 MoviePilot 插件配置中",
                          "persistent-hint": ""
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          modelValue: config.cms_timeout_hours,
                          "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((config.cms_timeout_hours) = $event)),
                          label: "CMS 任务超时（小时）",
                          type: "number",
                          min: "1",
                          max: "72",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_select, {
                          modelValue: config.magnet_download_mode,
                          "onUpdate:modelValue": _cache[35] || (_cache[35] = $event => ((config.magnet_download_mode) = $event)),
                          items: magnetModeOptions,
                          label: "磁力离线方式",
                          variant: "outlined",
                          density: "compact",
                          "hide-details": ""
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[36] || (_cache[36] = $event => ((config.direct_timeout_hours) = $event)),
                          label: "115 直连超时（小时）",
                          type: "number",
                          min: "1",
                          max: "72",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[37] || (_cache[37] = $event => ((config.offline_poll_seconds) = $event)),
                          label: "任务状态轮询（秒）",
                          type: "number",
                          min: "15",
                          max: "3600",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[38] || (_cache[38] = $event => ((config.offline_max_retries) = $event)),
                          label: "115 请求最大重试",
                          type: "number",
                          min: "0",
                          max: "6",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[129] || (_cache[129] = _createElementVNode("div", { class: "mr-3" }, [
                        ...
                        _createVNode(_component_v_spacer),
                        _createVNode(_component_v_switch, {
                          modelValue: config.magnet_rotation_enabled,
                          "onUpdate:modelValue": _cache[39] || (_cache[39] = $event => ((config.magnet_rotation_enabled) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          modelValue: config.magnet_rotation_max_attempts,
                          "onUpdate:modelValue": _cache[40] || (_cache[40] = $event => ((config.magnet_rotation_max_attempts) = $event)),
                          label: "磁力最大尝试数",
                          type: "number",
                          min: "1",
                          max: "10",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          modelValue: config.magnet_rotation_timeout_hours,
                          "onUpdate:modelValue": _cache[41] || (_cache[41] = $event => ((config.magnet_rotation_timeout_hours) = $event)),
                          label: "轮换队列超时（小时）",
                          type: "number",
                          min: "1",
                          max: "72",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[42] || (_cache[42] = $event => ((config.magnet_no_progress_timeout_minutes) = $event)),
                          label: "单候选无进展超时（分钟）",
                          type: "number",
                          min: "10",
                          max: "180",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[43] || (_cache[43] = $event => ((config.magnet_rotation_unknown_timeout_minutes) = $event)),
                          label: "未知状态对账超时（分钟）",
                          type: "number",
                          min: "1",
                          max: "1440",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[44] || (_cache[44] = $event => ((config.magnet_cancel_failover) = $event)),
                          label: "取消后自动切换",
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_switch, {
                          ...
                          "onUpdate:modelValue": _cache[45] || (_cache[45] = $event => ((config.magnet_fallback_enabled) = $event)),
                          label: "候选耗尽后回退 MP",
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[130] || (_cache[130] = _createElementVNode("div", { class: "mr-3" }, [
                          _createElementVNode("div", { class: "text-subtitle-2" }, "等待 MoviePilot 整理完成"),
                          _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "115 下载完成后仍等待 MP 订阅历史确认，不提前发送完成通知")
                        ], -1)),
                        _createVNode(_component_v_spacer),
                        _createVNode(_component_v_switch, {
                          modelValue: config.wait_for_mp_organize,
                          "onUpdate:modelValue": _cache[46] || (_cache[46] = $event => ((config.wait_for_mp_organize) = $event)),
                          color: "primary",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[131] || (_cache[131] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "允许详情页手动取消 115 直接任务", -1)),
                        _createVNode(_component_v_spacer),
                        _createVNode(_component_v_switch, {
                          modelValue: config.offline_allow_cancel,
                          "onUpdate:modelValue": _cache[47] || (_cache[47] = $event => ((config.offline_allow_cancel) = $event)),
                          color: "warning",
                          "hide-details": "",
                          density: "compact"
                        }, null, 8, ["modelValue"])
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[137] || (_cache[137] = _createElementVNode("div", { class: "section-label mb-2" }, "PanSou 聚合搜索", -1)),
                _cache[138] || (_cache[138] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, "作为 TG 和观影后的补充召回来源；结果仍需经过 MoviePilot 规则、媒体 ID、类型和季号确认。", -1)),
                _createVNode(_component_v_row, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_v_col, {
                      cols: "12",
                    ...
                    _createVNode(_component_v_col, {
                      ...
                      default: _withCtx(() => [
                        _cache[136] || (_cache[136] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "强制刷新缓存", -1)),
                        _createVNode(_component_v_spacer),
                        _createVNode(_component_v_switch, {
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[141] || (_cache[141] = _createElementVNode("div", { class: "section-label mb-2" }, "聚影开发者 API", -1)),
                _cache[142] || (_cache[142] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-3" }, "官方 API 搜索（AppID+API Key 鉴权），稳定无 IP 封锁。非开发者用开发者的 AppID + 自己的 API Key", -1)),
                _createVNode(_component_v_row, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_v_col, {
                      cols: "12",
                      ...
                      default: _withCtx(() => [
                        _cache[139] || (_cache[139] = _createElementVNode("div", { class: "mr-2" }, [
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[143] || (_cache[143] = _createTextVNode("批量导入频道 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[146] || (_cache[146] = _createTextVNode("确认删除 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[151] || (_cache[151] = _createTextVNode("115 扫码登录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
              ...
              default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_31, [
                  (qrPolling.value)
                    ...
                    : _createCommentVNode("", true),
                  _createElementVNode("span", _hoisted_32, _toDisplayString(qrMsg.value || '请使用 115 客户端扫码'), 1)
                ])
              ]),
              _: 1
            }),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[154] || (_cache[154] = _createTextVNode("选择 115 目录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, {
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_33, [
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(dirBrowserPath.value.slice(1), (p, i) => {
                    return (_openBlock(), _createElementBlock(_Fragment, { key: i }, [
                      ...
                      _createElementVNode("span", _hoisted_34, _toDisplayString(p.name), 1)
                    ], 64))
                  }), 128)),
                  _createVNode(_component_v_spacer),
                ...
                (!dirBrowserLoading.value && !dirBrowserDirs.value.length)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_35, "无子目录"))
                  : _createCommentVNode("", true)
              ]),
              _: 1
            }),
            ...
            _createVNode(_component_v_card_actions, { class: "px-4 py-3" }, {
              default: _withCtx(() => [
                _createElementVNode("span", _hoisted_36, "当前: " + _toDisplayString(dirBrowserPathStr.value || '/'), 1),
                _createVNode(_component_v_spacer),
                _createVNode(_component_v_btn, {
                  variant: "text",
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[161] || (_cache[161] = _createTextVNode("确认批量删除 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, { class: "text-body-2 pt-4" }, {
              default: _withCtx(() => [
                _cache[162] || (_cache[162] = _createTextVNode(" 确定要删除选中的 ", -1)),
                _createElementVNode("strong", null, _toDisplayString(selectedChannels.value.length), 1),
                _cache[163] || (_cache[163] = _createTextVNode(" 个频道吗？此操作不可撤销。 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-0d261fd2"]]);
