...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    const FRONTEND_BUILD_ID = "v4.8.19-circuit-breaker-fix" ;
    const FRONTEND_BUILD_TIME = "2026-09-20T10:25:22.618Z" ;
    const props = __props;
    const emit = __emit;
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9670717d"]]);
