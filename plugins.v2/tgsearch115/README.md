...
当前版本：`v4.7.41`。CMS 配置、状态和操作入口已从用户界面及公开配置输出隐藏；资源分类日志与通知增加来源、类型、年份、季集、画质、编码、字幕、语言、HDR、身份、规则、去重和最终动作。历史 `CmsTaskLedger` 名称与持久化键继续保留，仅用于 115 磁力幂等、状态轮询和重启恢复，不会调用外部 CMS。
